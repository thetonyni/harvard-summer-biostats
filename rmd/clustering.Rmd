...
Our cluster sizes are extremely uneven... Our first clsuter has 172 wells and the second has 18 and third has 1.
...
There does seem to be something of interest here... The first cluster has 30 wells that are "SI," the second cluster has much more of a mix with 32 "L", 5 "M", and 108 "SI" wells. The third cluster has 16 wells that are "L".
